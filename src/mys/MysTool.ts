...
const hk4_gacha_api = 'https://public-operation-hk4e.mihoyo.com/'
...
function setRegion (regions) {
  ...
  return regions.map((region, idx) => {
    return { region, name: names[idx] }
  })
}

const game_region = {
  gs: [
    { region: 'cn_gf01', name: '天空岛(官服)' }, { region: 'cn_qd01', name: '世界树(B服)' },
    ...setRegion(['os_usa', 'os_euro', 'os_asia', 'os_cht'])
  ],
  sr: [
    { region: 'prod_gf_cn', name: '星穹列车(官服)' }, { region: 'prod_qd_cn', name: '无名客(B服)' },
...
export {
  app_id, app_version, bbs_api, game_biz, game_region, hk4_api, hk4_gacha_api, hk4e_sdk_api,
  new_web_api, os_bbs_api, os_hk4_api, os_public_api, os_public_data_api, os_record_api, os_web_api,
  pass_api, public_data_api, record_api, salt, static_api, web_api
}
export default {
  app_id, app_version, bbs_api, game_biz, game_region, hk4_api, hk4_gacha_api, hk4e_sdk_api,
  new_web_api, os_bbs_api, os_hk4_api, os_public_api, os_public_data_api, os_record_api, os_web_api,
