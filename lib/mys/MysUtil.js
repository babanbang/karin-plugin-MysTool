...
const MysUtil = {
  ...
  servs: ['mys', 'hoyolab'],
  getServ (uid, game) {
    return (game == 'zzz' ? /^(10|13|15|17)[0-9]{8}/i : /^(18|[6-9])[0-9]{8}/i).test(uid) ? this.servs[1] : this.servs[0]
  },
  ...
  matchUid (msg, game) {
    const uid = msg.match(game === 'zzz' ? /((10|13|15|17)[0-9]{8}|[1-9][0-9]{7})/g : /((18|[1-9])[0-9]{8})/g)
